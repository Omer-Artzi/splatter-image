...
|------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------|
| **3D Point Clouds**          | <div align="center"><img src="./images/point_cloud_rotation_orig.gif" alt="3D Point Cloud - Original Model" width="600"></div>            | This gif shows how Gaussians are positioned in 3D space. Their distribution reflects the spatial representation of the object and impacts the reconstruction quality.   | <div align="center"><img src="./images/point_cloud_rotation_our.gif" alt="3D Point Cloud - Our Model" width="600"></div> |
| **Opacity Maps**             | <div align="center"><img src="./images/point_cloud_opacity_rotation_orig.gif" alt="Opacity Rotation - Original Model" width="600"></div> | This gif visualizes opacity values, highlighting areas of transparency and opacity, which is crucial for capturing translucent surfaces.                                | <div align="center"><img src="./images/point_cloud_opacity_rotation_our.gif" alt="Opacity Rotation - Our Model" width="600"></div> |
| **Scaling Dimensions - X**   | <div align="center"><img src="./images/scale_x_rotation_orig.gif" alt="Scaling X Rotation - Original Model" width="600"></div>           | These gifs represent the scaling of Gaussians along the X, Y, and Z axes, showing anisotropic stretching in each dimension and reflecting the object's surface features. | <div align="center"><img src="./images/scale_x_rotation_our.gif" alt="Scaling X Rotation - Our Model" width="600"></div> |
| **Scaling Dimensions - Y**   | <div align="center"><img src="./images/scale_y_rotation_orig.gif" alt="Scaling Y Rotation - Original Model" width="600"></div>           | Scaling along the Y-axis                                                                                                                                                | <div align="center"><img src="./images/scale_y_rotation_our.gif" alt="Scaling Y Rotation - Our Model" width="600"></div> |
| **Scaling Dimensions - Z**   | <div align="center"><img src="./images/scale_z_rotation_orig.gif" alt="Scaling Z Rotation - Original Model" width="600"></div>           | Scaling along the Z-axis                                                                                                                                                | <div align="center"><img src="./images/scale_z_rotation_our.gif" alt="Scaling Z Rotation - Our Model" width="600"></div> |
| **Quaternion X Rotation**    | <div align="center"><img src="./images/quaternion_x_rotation_orig.gif" alt="Quaternion X Rotation - Original Model" width="600"></div>   | These gifs represent quaternion-based rotations along each axis. Quaternions prevent gimbal lock, enabling smooth 3D rotations for rendering processes.                 | <div align="center"><img src="./images/quaternion_x_rotation_our.gif" alt="Quaternion X Rotation - Our Model" width="600"></div> |
| **Quaternion Y Rotation**    | <div align="center"><img src="./images/quaternion_y_rotation_orig.gif" alt="Quaternion Y Rotation - Original Model" width="600"></div>   | Rotation along the Y-axis                                                                                                                                               | <div align="center"><img src="./images/quaternion_y_rotation_our.gif" alt="Quaternion Y Rotation - Our Model" width="600"></div> |
| **Quaternion Z Rotation**    | <div align="center"><img src="./images/quaternion_z_rotation_orig.gif" alt="Quaternion Z Rotation - Original Model" width="600"></div>   | Rotation along the Z-axis                                                                                                                                               | <div align="center"><img src="./images/quaternion_z_rotation_our.gif" alt="Quaternion Z Rotation - Our Model" width="600"></div> |
| **Quaternion W Rotation**    | <div align="center"><img src="./images/quaternion_w_rotation_orig.gif" alt="Quaternion W Rotation - Original Model" width="600"></div>   | Rotation along the W-axis                                                                                                                  | <div align="center"><img src="./images/quaternion_w_rotation_our.gif" alt="Quaternion W Rotation - Our Model" width="600"></div> |
| **Output Model OBJ** | <div align="center"><img src="./images/loop_orig.gif" alt="Original Model" width="600"></div>                                            | Created output obj model                                                                                                                                                | <div align="center"><img src="./images/loop_our.gif" alt="Our Model" width="600"></div>                    |
